...
##
traj_msg.trajectory.points.append(JointTrajectoryPoint(positions=[-2.0, 0, 0, 0, 1.3], #姿勢1
                                                       time_from_start = rospy.Duration(1))) ## 前の姿勢から1sec
traj_msg.trajectory.points.append(JointTrajectoryPoint(positions=[2.0, 0, 0, 0, 1.3], #姿勢2
