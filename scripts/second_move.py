...
traj_msg.trajectory.points.append(JointTrajectoryPoint(positions=[0, 0, 2.0, -2.0, 0], #姿勢2
                                                       time_from_start = rospy.Duration(6)))## 前の姿勢から4sec
traj_msg.trajectory.points.append(JointTrajectoryPoint(positions=[0, 0, 0.20, -0.40, 0], #姿勢3
