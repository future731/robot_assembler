...
##
traj_msg.trajectory.points.append(JointTrajectoryPoint(positions=[0, 0, 0.20, -0.40], #姿勢1
                                                       time_from_start = rospy.Duration(2))) ## 前の姿勢から2sec
traj_msg.trajectory.points.append(JointTrajectoryPoint(positions=[0, 0, 0.40, -0.80], #姿勢2
                                                       time_from_start = rospy.Duration(6)))## 前の姿勢から4sec
traj_msg.trajectory.points.append(JointTrajectoryPoint(positions=[0, 0, 0.20, -0.40], #姿勢3
                                                       time_from_start = rospy.Duration(10)))## 前の姿勢から4sec
traj_msg.trajectory.points.append(JointTrajectoryPoint(positions=[0, 0, 0.15, -0.3], #姿勢4
